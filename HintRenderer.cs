...
public class HintRenderer : MonoBehaviour
{
    ...
    private void OnDraw()
    {
        ...
        while ((x != 0 || y != 0) && positions.Count < 10000)
        {
            ...
            positions.Add(new Vector3(x * MazeSpawner.CellSize.x + Ground.x, y * MazeSpawner.CellSize.y + Ground.y, y * MazeSpawner.CellSize.z + Ground.z));
